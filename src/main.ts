...
const tools: Tool[] = ['woodcutter', 'sawmill', 'quarry', 'house', 'warehouse', 'bridge', 'outpost', 'road', 'farm', 'forester', 'workshop', 'academy', 'townhall', 'mine', 'smelter', 'forge', 'miningHouse'];
