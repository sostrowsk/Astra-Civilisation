...
const categoryTools = () => buildCategory === 'pioneers' ? tools.slice(0, 8) : buildCategory === 'mining' ? tools.slice(13, 17) : buildCategory === 'textile' ? tools.slice(17) : tools.slice(8, 13);
